...
Revision ID: a403c79ce55c
Revises: 
Create Date: 2024-08-05 17:05:34.079572
...
def upgrade() -> None:
    ...
    sa.Column('updateTime', sa.DateTime(), nullable=False),
    sa.Column('name', sqlmodel.sql.sqltypes.AutoString(), nullable=False),
    sa.Column('describe', sqlmodel.sql.sqltypes.AutoString(), nullable=True),
